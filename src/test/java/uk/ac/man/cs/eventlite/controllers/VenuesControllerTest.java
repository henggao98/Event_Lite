...
public class VenuesControllerTest {
	...
	public void postNewVenue() throws Exception {
		...
		assertThat(venue.getId(), equalTo(arg.getValue().getId()));
		assertThat("Kilburn Building", equalTo(arg.getValue().getName()));
		assertThat(1000 ,equalTo(arg.getValue().getCapacity()));
		assertThat("Oxford Rd", equalTo(arg.getValue().getAddress()));
	...
	@Test
	public void postAddVenueWithErrors() throws Exception {
		mvc.perform(MockMvcRequestBuilders.post("/venues").with(user("Rob").roles(Security.ADMIN_ROLE))
				.contentType(MediaType.APPLICATION_FORM_URLENCODED)
				.param("id", "0")
				.param("name", "")
				.param("capacity", "-100")
				.param("address", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. "
