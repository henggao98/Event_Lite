...
public class EventsControllerApi {
	...
	public Resources<Resource<Event>> getEventsByName(@RequestParam(value="sname",required=false) String name) {

		return eventToResource(eventService.findByName(name));
	}
